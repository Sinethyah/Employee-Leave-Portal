...
export default class Employer extends Component{
    ...
    //collapse and open one of the sub-menu in the nav bar
    navLinkCollapse1(){
    ...
    render(){
        ...
        //if you want the sidebar to hover, but you also need to change the styles.css. Instructions in the readme.txt
        /*
        if (document.getElementById("layoutSidenav_nav")){
            document.getElementById("layoutSidenav_nav").addEventListener("mouseenter", (e) => {
                if (!timeout){
        ...
        if (document.getElementById("layoutSidenav_nav")){
            document.getElementById("layoutSidenav_nav").addEventListener("mouseleave", (e) => {
                if (timeout) {
                                ...
                                <div className="col-xl-13 col-md-10">
                                    <div className="card bg-primary text-white mb-4">
                                        ...
                                        <div className="card-footer d-flex align-items-center justify-content-between">
                                            <a className="small text-white stretched-link" href="/requestSummary">View Details</a>
