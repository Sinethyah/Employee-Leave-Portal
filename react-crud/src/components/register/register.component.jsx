...
export default class Register extends Component {
    constructor(props) {
        ...
        onChangeDaysAllocated(e) {
            this.setState({
                daysAllocated: e.target.value
            });
        }
        onChangeDaysUsed(e) {
            this.setState({
                daysUsed: e.target.value
            });
        }
        

        //handles registration(default)
        //sends information to the server about the user via AuthService.register()
        handleRegister(e) {
            e.preventDefault();
            this.setState({
                message: "",
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="form-control"
                                id="daysAllocated"
                                value={this.state.daysAllocated}
                            ...
                            <div className="form-group">
                            <label htmlFor="daysUsed">Days Used</label>
                            <input
                                type="text"
                                className="form-control"
                                id="daysUsed"
                                value={this.state.daysUsed}
